...
<template>
  ...
  >
    ...
    >
      ...
      <div class="divider font-bold divider-start">ระบบจัดการห้อง</div>
      <div
        @click="goto('room')"
        role="button"
        tabindex="0"
