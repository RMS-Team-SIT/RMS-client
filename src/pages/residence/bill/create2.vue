...
import BillRoomMap from '@/components/bill/bill.room-map.vue';
                ...
                <div class="flex w-full">
                  ...
                  <div class="w-full">
                    ...
                    <p>
                      ค่าเช่าห้อง:
                      <b>{{
                        meterRecordItem.room.roomRentalPrice.toLocaleString()
                      }}</b>
                      บาท
                    </p>
                    ...
                    <span>
                      <p
                        v-for="(fee, index) in meterRecordItem.room.fees"
                        :key="index"
                      >
                        {{ fee.feename }}:
                        <b>{{ fee.feeprice.toLocaleString() }}</b> บาท
                      </p>
                      <p v-if="!meterRecordItem.room.fees.length">
                ...
                <p class="text-lg font-bold mt-5 rounded-full">
                  ...
                  {{
                    (
                      ...
                      residence.defaultWaterPriceRate *
                        meterRecordItem.totalWaterMeterUsage +
                      meterRecordItem.room.fees.reduce(
